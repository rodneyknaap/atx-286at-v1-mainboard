...
If you are interested in this REV1 design, possibly you may like to take a look at the REV3 project. Current status of this project is that the mainboard design and the initial versions of the 5-CPLD quartus projects are finished, there is also a SRAM module design which this time is connected directly to the mainboard, and I am working on an EMS concept so we can swap out EMS pages in the entire first 1MB region. This memory configuration is my attempt to support the RealDOOM project by sqpat. I feel that his project is one of the best applications to run on a faster 286 CPU. If this is successful, it will probably be supported by a custom driver implementation in the future.
