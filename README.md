...
The REV3D system is now fully functional and able to boot and run software. I am still sorting out the optimal System controller design for a few typical clock frequencies of the 286 CPU such as 16MHz, 18MHz, 20MHz and 22MHz. A 20MHz rated Harris 286 is recommended. The REV3D design has certain advantages and improvements because all the manual development revisions which I have wired in on the REV1 system are now no longer needed and have become an integral part of the REV3D design. Besides this, the bus control is now fully done by CPLD chips as well and we don't need a lot of bus transceivers and address/data bus latches anymore to create a system. This creates a much more fixed and predictable bus operation and transfer speeds of signals.

Besides this there is also a new EMS system integrated into the design which eventually is meant to support the RealDOOM project by sqpat here on GitHub (https://github.com/sqpat/RealDOOM) of which I am a huge fan. I am working with sqpat to develop a custom RealDOOM compatible EMS driver eventually, the RealDOOM is at the moment still undergoing a lot of development by sqpat. Basically running RealDOOM is a great application to demonstrate the coolest DOOM gameplay fun which the game is able to offer including music and sound effects, tweakable graphics detail and other cool stuff, and also giving a really great demonstration of what the 286 CPU is capable of doing in an optimal system.  
